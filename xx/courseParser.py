...
file_path = "./Sample_Input3.pdf" #Degree Works
...
CoursesDict = readXL("./CPSCXL.xlsx", CoursesDict)
for x in CoursesDict:
    if (CoursesDict[x].Completed == False):
        print(CoursesDict[x].CourseNum, " Completed: ", CoursesDict[x].isComplete(), " Hours: ", CoursesDict[x].CreditHours," Can be taken: ",CoursesDict[x].canBeTaken())
